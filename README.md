...
Bash script for updating "[sepl-connector-client](https://github.com/SmartEnergyPlatform/client-connector-lib)" client connectors via git and pip.
...
`git clone https://github.com/SmartEnergyPlatform/client-connector-updater.git client-connector-updater`
